...
import { getLinks } from "../../utils/queryFn"
            ...
            {data.pages ? (
              <div className="flex flex-col gap-10">
                {data.pages.map((links) => (
                  <>
                    {links.data.map((link) => (
                      <span className="flex flex-col gap-4 sm:flex-row sm:gap-4">
                        <label
                          className="w-80 text-black sm:w-64 input bg-[#D7D5D5] truncate inline-flex items-center justify-self-center"
                        >
                          {link.URL}
                        </label>
                        <label
                        ...
                        <span
                          className="hidden w-44 text-green-500 cursor-pointer sm:inline-flex sm:w-10"
                        >
                        ...
                        <span
                          className="hidden w-44 text-red-400 cursor-pointer sm:inline-flex sm:w-10"
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="">
